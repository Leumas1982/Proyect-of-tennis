...
Builder.load_file('kvs/segund.kv')
Builder.load_file('kvs/crea.kv')
Builder.load_file('kvs/mapview.kv')
...
class MapViewApp(App):
    def build(self):
        self.mapview = MapView(zoom=18, lat=37.7749, lon=-122.4194)
        return self.mapview
    ...
    def __init__(self, **kwargs):
        ...
        self.gps = gps = gps.GPS()
        gps.start()
        gps.bind(on_location=self.on_position)
        self.mapview.center_on(*gps.location)
...
class MainApp(MDApp):
    ...
    def build(self):
        ...
        screens = [
            ...
            SegundScreen(name='second'),
            SigninScreen(name='start'),
            MainScreen(name='home'),
            CreaScreen(name='crea'),
            MapViewScreen(name= 'map')
